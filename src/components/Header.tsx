...
export default function Header({ portfolio }: HeaderProps) {
  ...
  return (
    <header
      className={`flex justify-between items-center py-3 px-20 bg-[var(--bg-light-secondary)] dark:bg-[var(--bg-dark-secondary)] text-5xl font-bold sticky top-0 z-20 ${chakra.className}`}
      style={{ boxShadow: "0px 4px 6px rgba(0, 0, 0, 0.4)" }}
    >
        {portfolio && 
        <Link href="/" className={`button-gradient text-xl font-bold py-1 pl-2 pr-10 border border-transparent transition-color ${
